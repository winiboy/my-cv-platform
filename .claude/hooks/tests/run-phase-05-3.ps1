...
$fixtures = @(
    ...
    @{ Name='SAFE: git merge feature';               Data=@{tool_name='Bash'; tool_input=@{command='git merge feature'};      cwd=$featCwd}; Exp='no-decision' },
    ...
    @{ Name='SAFE: git push';                        Data=@{tool_name='Bash'; tool_input=@{command='git push'};               cwd=$featCwd}; Exp='no-decision' },
    @{ Name='SAFE: git push origin main';            Data=@{tool_name='Bash'; tool_input=@{command='git push origin main'};   cwd=$featCwd}; Exp='no-decision' },
    @{ Name='SAFE: gh pr create';                    Data=@{tool_name='Bash'; tool_input=@{command='gh pr create'};           cwd=$featCwd}; Exp='no-decision' },
    @{ Name='SAFE: gh pr merge 123';                 Data=@{tool_name='Bash'; tool_input=@{command='gh pr merge 123'};        cwd=$featCwd}; Exp='no-decision' },
